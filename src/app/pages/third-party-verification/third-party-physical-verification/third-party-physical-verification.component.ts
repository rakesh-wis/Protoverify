...
@Component({
	selector: 'app-third-party-physical-verification',
	templateUrl: './third-party-physical-verification.component.html',
	styleUrls: ['./third-party-physical-verification.component.scss'],
})
export class ThirdPartyPhysicalVerificationComponent implements OnInit {
	businessDocuments = [
		{
